...
def get_itemname():
    ...
    trino.create_table(table_name='metadata_weapon',
                       schema_name=schema_name,
                       table_columns=trino.extract_columns(df_weapon),
                       partitioning=None,
                       sorted_by=None)
    trino.create_table(table_name='metadata_armor',
                       schema_name=schema_name,
                       table_columns=trino.extract_columns(df_armor),
                       partitioning=None,
                       sorted_by=None)
    trino.create_table(table_name='metadata_dougu',
                       schema_name=schema_name,
                       table_columns=trino.extract_columns(df_dougu),
                       partitioning=None,
                       sorted_by=None)
    trino.insert_table('metadata_weapon', schema_name, df_weapon, replace=True)
    trino.insert_table('metadata_armor', schema_name, df_armor, replace=True)
    trino.insert_table('metadata_dougu', schema_name, df_dougu, replace=True)
